...
# The HTML content (same as provided, optimized for pdfkit)
html_content = """
<!DOCTYPE html>
<html lang="en">
<head>
...
# Generate PDF
def generate_resume_pdf(html_content, output_path="resume.pdf"):
    try:
        ...
        if os.path.exists(wkhtmltopdf_path):
            ...
            print(f"wkhtmltopdf not found at {wkhtmltopdf_path}. Trying system PATH...")

        # PDF options for A4 size and margins
        options = {
            'page-size': 'A4',
            'margin-top': '0.4in',
            'margin-right': '0.4in',
...
if __name__ == "__main__":
    generate_resume_pdf(html_content)